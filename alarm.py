...
if __name__ == "__main__" :
    # TODO the probability of Mary Calling given that John called
    q = alarm_infer.query(variables=["MaryCalls"],evidence={"JohnCalls":"yes"})
    print(q)

    # TODO The probability of both John and Mary calling given Alarm
    q = alarm_infer.query(variables=["JohnCalls", "MaryCalls"],evidence={"Alarm":"yes"})
    print(q)

    # TODO the probability of Alarm, given that Mary called.
